...
export {
    ...
    CountryCode, E164Number, Examples, Extension, MetadataJson, NationalNumber, NumberFormat, NumberFoundLegacy, NumberingPlan, NumberType, ParseError, ValidatePhoneNumberLengthResult
};
