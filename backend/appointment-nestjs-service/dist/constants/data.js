...
exports.locations = exports.foods = void 0;
exports.foods = [
    {
        label: 'Com_Tam',
        name: 'Cơm Tấm',
    ...
    },
    {
        ...
        description: 'Cao Lau is a Vietnamese dish famous in the Central region. Cao Lau features yellow-colored noodles served with a small amount of broth (simmered from pork bones), topped with slices of char siu pork, shrimp, pork, and accompanied by various fresh herbs and crispy fried (or grilled) rice crackers, creating a unique and enticing culinary experience in Vietnamese cuisine culture. This is a dish worth trying when visiting Vietnam.',
    },
    {
        label: 'Mi_Quang',
        name: 'Mì Quảng',
...
exports.locations = [
    ...
    },
    {
        ...
        description: "Buu Long Pagoda is one of the most uniquely descriptionigned temples, reminiscent of the Golden Temple in Thailand. According to the sharing of Master Vien Minh, the temple was inspired by the architectural style of Buddhism coordinatesginating from India. Situated in the temple's courtyard is a large lake. Directly behind the lake stands the 56-meter-tall Gotama Cetiya tower. This tower is also hailed as the largest stupa in Vietnam. Apart from its distinctive architectural features, the pagoda is perched atop a hill, offering visitors not only a sense of serenity but also refreshing, clean air. This is truly a spiritual tourism descriptiontination that visitors to Ho Chi Minh City cannot miss. The pagoda is open to visitors from 8:00 AM to 6:00 PM daily.",
    },
    {
    ...
    },
    {
        ...
        description: "The Ngoc Hoang Pagoda, also known as the Ngoc Hoang Temple (Phuoc Hai Tu), is a familiar ancient temple to the people of Saigon and tourists alike, with its captivating and unique beauty. Constructed at the beginning of the 20th century in Saigon by a Chinese individual named Luu Minh, the architecture here bears many characteristics of that nation. Unlike the venerable appearance of ancient Chinese architecture, the interiors of the temple have been partially renovated. Alongside preserving the ancient architectural features, the temple's decorations and motifs are vibrant, adding to its allure. Additionally, with its Taoist beliefs in worshipping many deities, Ngoc Hoang Pagoda is a sacred place where one can pray for fertility, love, and peace. The temple is open every day from 7 am to 6 pm.",
    },
];
